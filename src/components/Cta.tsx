...
// Generated: 2025-08-21T17:26:29.017Z
// Section: cta
// Category: cta
...
export default function InvoicelyFeaturesCTA() {
  const stats = [
    { value: "50K+", label: "Businesses Served", icon: Users },
    { value: "99.9%", label: "Uptime Guarantee", icon: Shield },
    { value: "200+", label: "Integrations", icon: Zap },
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Invoicely for Your Business
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Streamline your invoicing, payments, and financial management with Invoicely.
