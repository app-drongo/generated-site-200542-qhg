...
// Generated: 2025-08-21T17:26:28.360Z
// Section: page-header
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Discover Invoicely's flexible pricing plans, designed to fit the unique needs of your small or medium-sized business.
            Streamline your invoicing process and focus on what matters most - growing your company.
          </p>
        </div>
      </div>
    </section>
