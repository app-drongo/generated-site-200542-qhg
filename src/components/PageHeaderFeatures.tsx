...
// Generated: 2025-08-21T17:26:28.821Z
// Section: page-header
...
export default function InvoicelyFeaturesPageHeader() {
  const breadcrumbs = [
    { label: "Home", href: "/" },
        ...
        <div className="relative py-12 sm:py-16 lg:py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl">
              Discover the powerful features that make Invoicely the ultimate invoicing solution 
