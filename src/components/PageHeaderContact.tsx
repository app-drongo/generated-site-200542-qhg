...
// Generated: 2025-08-21T17:26:29.108Z
// Section: page-header
...
export default function InvoicelyContactPageHeader() {
  const breadcrumbs = [
    { label: "Home", href: "/" },
    { label: "Contact" }
  ]
        ...
        <div className="relative py-12 sm:py-16 lg:py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl">
              Have a question or need help with our invoicing solution? 
              Our team is here to assist you. Fill out the contact form below 
